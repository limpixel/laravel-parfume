                ...
                <div class="s-header__block">
                    <div class="header-logo">
                        <a class="logo" href="index.html">
                            <img src="{{ asset('images/logo-perfume.png') }}" alt="Homepage">
                        </a>
                    </div>
                ...
                <nav class="header-nav">
                    ...
                    <div class="header-contact flex ">
                        <ul class="header-nav__links">
                            ...
                            {{-- @if (Route::has('login'))
                                @auth
                                    <li class="current"><a class="smoothscroll" href="{{ url('/dashboard') }}">Dashboard</a></li>
                                
                                @else
                                    
                                    <li><a class="smoothscroll" href="{{ route('login') }}">Register</a></li>
                                @endauth
                            @endif --}}
                            ...
                            {{-- Target --}}
                            @if (Route::has('login'))
                                <nav style="display: flex" class="-mx-3 flex flex-1 justify-end">
                                    @auth
        ...
        <section id="intro" class="container s-intro target-section">
            ...
            <div class="grid-block s-intro__content">
                ...
                <figure class="intro-pic-primary">
                    <img src="https://i.pinimg.com/736x/94/37/86/943786159d2ea934ffe778fa1e970bd2.jpg"
                        srcset="https://i.pinimg.com/736x/94/37/86/943786159d2ea934ffe778fa1e970bd2.jpg 1x, 
                         https://i.pinimg.com/736x/94/37/86/943786159d2ea934ffe778fa1e970bd2.jpg 2x"
                        alt="">
                ...
                <div class="intro-block-content">
                    ...
                    <figure class="intro-block-content__pic">
                        <img src="https://i.pinimg.com/736x/0c/b1/79/0cb179dcee9e78affa5fd244d9ee5513.jpg"
                            srcset="https://i.pinimg.com/736x/0c/b1/79/0cb179dcee9e78affa5fd244d9ee5513.jpg 1x, 
                             https://i.pinimg.com/736x/0c/b1/79/0cb179dcee9e78affa5fd244d9ee5513.jpg 2x"
                            alt="">
            ...
            <div class="row s-about__content">
                ...
                <div class="column xl-4 lg-5 md-12 s-about__content-start">
                    ...
                    <figure class="about-pic-primary">
                        <img src="https://i.pinimg.com/736x/ab/3a/ad/ab3aad65ca540a7424d35216974b71f7.jpg"
                            srcset="https://i.pinimg.com/736x/ab/3a/ad/ab3aad65ca540a7424d35216974b71f7.jpg 1x, 
                             https://i.pinimg.com/736x/ab/3a/ad/ab3aad65ca540a7424d35216974b71f7.jpg 2x"
                            alt="">
                    </figure>
            ...
            <div class="row s-menu__content">
                ...
                <div class="column xl-4 lg-5 md-12 s-menu__content-start">
                    ...
                    <div class="section-header" data-num="02">
                        <h2 class="text-display-title">Our Perfume</h2>
                    </div>
                ...
                <div class="column xl-6 lg-6 md-12 s-menu__content-end">
                    ...
                    <div class="tab-content menu-block">
                        ...
                        <div id="designer-perfume" class="menu-block__group tab-content__item">
                            ...
                            <ul class="menu-list">
                                <li class="menu-list__item">
                                    <div class="menu-list__item-desc">
                                        ...
                                        <p>
                                            Citrus–spicy–woody, sensual & intens.
                                        </p>
                                    </div>
                                ...
                                <li class="menu-list__item">
                                    <div class="menu-list__item-desc">
                                        ...
                                        <p>
                                            spicy–gourmand, elegan untuk pria modern.
                                        </p>
                                    </div>
                                    <div class="menu-list__item-price">
                                        <span>$</span> 75
                                ...
                                <li class="menu-list__item">
                                    <div class="menu-list__item-desc">
                                        ...
                                        <p>
                                            Woody aromatic, fresh-masculine, Advanture Vibes
                                        </p>
                                    </div>
                                    <div class="menu-list__item-price">
                                        <span>$</span>95.00
                                ...
                                <li class="menu-list__item">
                                    <div class="menu-list__item-desc">
                                        <h4>YSL MYSLF EDP</h4>
                                        <p>
                                            Floral woody musk, modern & clean.
                                        </p>
                                    </div>
                                    <div class="menu-list__item-price">
                                        <span>$</span>150
                        ...
                        <div id="middle-eastern-nichie-inspired" class="menu-block__group tab-content__item">

                            <h6 class="menu-block__cat-name">
                                Middle Eastern / Nichie Inspired Perfume
                            </h6>
                            ...
                            <ul class="menu-list">
                                <li class="menu-list__item">
                                    <div class="menu-list__item-desc">
                                        ...
                                        <p>
                                            Oudy–woody khas parfum Arab, Luxury Vibes.
                                        </p>
                                    </div>
                                    <div class="menu-list__item-price">
                                        <span>$</span>65.00
                                ...
                                <li class="menu-list__item">
                                    <div class="menu-list__item-desc">
                                        ...
                                        <p>
                                            Fresh–spicy–sweet, Inspiration of Designer Perfume
                                        </p>
                                    </div>
                                    <div class="menu-list__item-price">
                                        <span>$</span>50
                        ...
                        <div id="affordable-clone-houses" class="menu-block__group tab-content__item">
                            ...
                            <ul class="menu-list">
                                ...
                                <li class="menu-list__item">
                                    <div class="menu-list__item-desc">
                                        ...
                                        <p>
                                            Woody–ambery, Alternative Niche Perfume.
                                        </p>
                                    </div>
                                    <div class="menu-list__item-price">
                                        <span>$</span>55.00
        ...
        <section id="gallery" class="container s-gallery target-section">
            ...
            <div class="gallery-items grid-cols grid-cols--wrap">
                ...
                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/versace-eros-flame.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/versace-eros-flame.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/versace-eros-flame.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/versace-eros-flame.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item-->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/armaf-club-de-nuit-intense-man.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/armaf-club-de-nuit-intense-man.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/armaf-club-de-nuit-intense-man.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/armaf-club-de-nuit-intense-man.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/armaf-urban-man-elixir.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/armaf-urban-man-elixir.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/armaf-urban-man-elixir.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/armaf-urban-man-elixir.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/ferragamo-salvatore.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/ferragamo-salvatore.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/ferragamo-salvatore.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/ferragamo-salvatore.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/montblanc-explorer.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/montblanc-explorer.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/montblanc-explorer.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/montblanc-explorer.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/ysl-myslf-edp.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/ysl-myslf-edp.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/ysl-myslf-edp.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/ysl-myslf-edp.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/zimaya-sharaf-the-club.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/zimaya-sharaf-the-club.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/zimaya-sharaf-the-club.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/zimaya-sharaf-the-club.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/turathi-electric.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/turathi-electric.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/turathi-electric.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/turathi-electric.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/lattafa-asad.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/lattafa-asad.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/lattafa-asad.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/lattafa-asad.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->

                <div class="gallery-items__item grid-cols__column">
                    <a href="{{ asset('images/perfume-image/gallery-ratio-only/proud-of-you-intense.png') }}"
                        class="gallery-items__item-thumb glightbox">
                        <img src="{{ asset('images/perfume-image/gallery-ratio-only/proud-of-you-intense.png') }}"
                            srcset="{{ asset('images/perfume-image/gallery-ratio-only/proud-of-you-intense.png') }} 1x, 
                                    {{ asset('images/perfume-image/gallery-ratio-only/proud-of-you-intense.png') }} 2x"
                            alt="">
                    </a>
                </div> <!-- end gallery-items__item -->
